...
var TreeView = _react.default.forwardRef(function TreeView(props, ref) {
  var children = props.children,
      ...
      other = (0, _objectWithoutProperties2.default)(props, ["children", "classes", "className", "defaultCollapseIcon", "defaultEndIcon", "defaultExpanded", "defaultExpandIcon", "defaultParentIcon", "expanded", "onNodeToggle"]);
  ...
  var _React$useRef = _react.default.useRef(expandedProp !== undefined),
      isControlled = _React$useRef.current;

  var _React$useState3 = _react.default.useState(defaultExpanded),
  ...
  var prevChildIds = _react.default.useRef([]);
    ...
    if (map) {
      if (map.parent) {
        ...
        if (parentMap && parentMap.children) {
          ...
          nodeMap.current[map.parent] = (0, _extends2.default)({}, parentMap, {
