...
const Rating = React.forwardRef(function Rating(props, ref) {
  const {
    ...
    value: valueProp = null
        ...
        other = _objectWithoutPropertiesLoose(props, ["classes", "className", "disabled", "emptyIcon", "emptyLabelText", "getLabelText", "icon", "IconContainerComponent", "max", "name", "onChange", "onChangeActive", "onMouseLeave", "onMouseMove", "precision", "readOnly", "size", "value"]);
  ...
  const handleMouseMove = event => {
    ...
    const {
      width
    } = rootNode.querySelector(`.${classes.label}`).getBoundingClientRect();
    let percent;
  ...
  return React.createElement("span", _extends({
    ...
    className: classes.visuallyhidden
  }, emptyLabelText))), Array.from(new Array(max)).map((_, index) => {
