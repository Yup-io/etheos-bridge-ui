...
var NativeSvg = /** @class */ (function (_super) {
    ...
    NativeSvg.prototype.render = function () {
        ...
        delete props.speed;
        return (React__default.createElement(Svg__default, __assign({ viewBox: "0 0 " + width + " " + height, width: width, height: height, preserveAspectRatio: "none", style: composedStyle }, props),
            React__default.createElement(Svg.Rect, { x: "0", y: "0", width: width, height: height, fill: "url(#" + this.idClip + ")", clipPath: "url(#" + this.idGradient + ")" }),
